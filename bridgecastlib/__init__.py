...
class SocketHelper(object):
    def receive_uint8(self):
        return int.from_bytes(self._socket.recv(1), byteorder="big", signed=False)
    def receive_int8(self):
        return int.from_bytes(self._socket.recv(1), byteorder="big", signed=True)

    def receive_uint16(self):
        return int.from_bytes(self._socket.recv(2), byteorder="big", signed=False)
    def receive_int16(self):
        return int.from_bytes(self._socket.recv(2), byteorder="big", signed=True)

    def receive_uint32(self):
        return int.from_bytes(self._socket.recv(4), byteorder="big", signed=False)
    def receive_int32(self):
        return int.from_bytes(self._socket.recv(4), byteorder="big", signed=True)

    def receive_uint64(self):
        return int.from_bytes(self._socket.recv(8), byteorder="big", signed=False)
    def receive_int64(self):
        return int.from_bytes(self._socket.recv(8), byteorder="big", signed=True)
